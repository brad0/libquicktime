...
#define PARAM_BITRATE_TOLERANCE \
  { \
    ...
    .help_string = "Number of bits the bitstream is allowed to diverge from " \
...
#define PARAM_LUMA_ELIM_THRESHOLD \
  { \
    ...
    .val_min =     { .val_int = -99 }, \
    .val_max =     { .val_int =  99 }, \
    .help_string = "Single coefficient elimination threshold for luminance. " \
...
#define PARAM_STRICT_STANDARD_COMPLIANCE \
  { \
    ...
    .val_min =     { .val_int = -2 }, \
    .val_max =     { .val_int =  2 }, \
    .help_string = "2 = Strictly conform to a older more strict version of " \
...
#define PARAM_TEMPORAL_CPLX_MASKING \
  { \
    ...
    .val_max =     { .val_float =  1.0 }, \
    .num_digits =  2, \
    .help_string = "Encode very fast moving image parts with reduced " \
...
#define PARAM_P_MASKING \
  { \
    ...
    .val_max =     { .val_float =  1.0 }, \
    .num_digits =  2, \
    .help_string = "Encode inter blocks with reduced quality (increases the " \
...
#define PARAM_DIA_SIZE \
  { \
    ...
    .val_min =     { .val_int = -9 }, \
    .val_max =     { .val_int =  9 }, \
    .help_string = "Motion estimation diamond size. Negative means shape " \
                   "adaptive." \
  }
...
#define PARAM_PRE_DIA_SIZE \
  { \
    ...
    .val_min =     { .val_int = -9 }, \
    .val_max =     { .val_int = 9 }, \
    .help_string = "Motion estimation pre-pass diamond size. Negative means " \
                   "shape adaptive." \
  }
...
#define PARAM_ME_SUBPEL_QUALITY \
  { \
    ...
    .val_min =     { .val_int = 1 }, \
    .val_max =     { .val_int = 8 }, \
    .help_string = "Subpel motion estimation refinement quality (for qpel). " \
...
#define PARAM_LMAX \
  { \
    ...
    .val_min =     { .val_float = 31.0 }, \
    .num_digits =  1, \
    .help_string = "Maximum Lagrange multiplier for ratecontrol. Should " \
...
#define PARAM_RC_INITIAL_BUFFER_OCCUPANCY \
  { \
    ...
    .type =        LQT_PARAMETER_INT, \
    .val_default = { .val_int = 0 }, \
    .help_string = "Number of kilobits which should be loaded into the rc " \
...
#define PARAM_ME_THRESHOLD \
  { \
    ...
    .help_string = "Motion estimation threshold. under which no motion " \
...
#define PARAM_MB_THRESHOLD \
  { \
    ...
    .val_min =     { .val_int = 0 }, \
    .val_max =     { .val_int = 4000000 }, \
    .help_string = "Macroblock threshold. under which the user specified " \
...
#define PARAM_SCENECHANGE_FACTOR \
  { \
    ...
    .type =        LQT_PARAMETER_INT, \
    .val_default = { .val_int = 0 }, \
    .help_string = "Multiplied by qscale for each frame and added to " \
                   "scene_change_score" \
  }
...
#define PARAM_QSCALE \
  { \
    ...
    .val_min =     { .val_int = 1 }, \
    .val_max =     { .val_int = 31 }, \
    .help_string = "Quantizer for fixed quality encoding. Lower means " \
...
#define PARAM_FLAG_4MV \
  { \
    ...
    .val_min =     { .val_int = 0 }, \
    .val_max =     { .val_int = 1 }, \
    .help_string = "Allow 4 motion vectors per macroblock (slightly better " \
...
#define PARAM_FLAG_QPEL \
  { \
    ...
    .val_min =     { .val_int = 0 }, \
    .val_max =     { .val_int = 1 }, \
    .help_string = "Use 1/4 pixel motion compensation. Warning: QPEL is not " \
...
#define PARAM_FLAG_PART \
  { \
    ...
    .val_min =     { .val_int = 0 }, \
    .val_max =     { .val_int = 1 }, \
    .help_string = "Use data partitioning for more robustnedd if the video " \
...
#define PARAM_FLAG_OBMC \
  { \
    ...
    .val_min =     { .val_int = 0 }, \
    .val_max =     { .val_int = 1 }, \
    .help_string = "Overlapped block motion compensation (only supported " \
